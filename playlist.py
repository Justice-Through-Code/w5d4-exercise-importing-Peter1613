...
display_playlist(my_playlist) # Peter's note to self: This will print "Playlist is empty!" because there is nothing in your playlist
...
'''
add_song(my_playlist, {'artist': 'Russell Watson', 'title': 'Faith of the Heart'})
...
add_song(my_playlist, {'artist': 'Air Supply', 'title': 'Lost in Love'})
add_song(my_playlist, {'artist': 'Pat Benatar', 'title': 'Fire and Ice'})
...
# See playlist_helpers.py for details on how to define this function # Peter's Note: Done.
...
avg_mon_pla = np.mean(monthly_plays)
print(avg_mon_pla)
